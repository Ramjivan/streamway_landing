...
const Feature = () => {
  return (
    <div className=" w-screen  mt-32 h-full md:pl-44 container">
      ...
      <div className="z-40 bg-white relative backdrop-blur-sm bg-opacity-70 shadow-sm w-[85%] ml-5  ">
        <div className="divide-x-[1px] md:flex  p-10 text-2xl text-center font-normal tracking-normalS">
          <span className="p-8 space-y-3">
            ...
            <p className="text-slate-400 text-lg">Easy Setup</p>
          ...
          <span className="p-8 space-y-3">
            ...
            <p className="text-slate-400 text-lg">Multistreaming</p>
            <p>
