...
const CEO = () => {
  return (
    <div className="container w-full h-[80%] bg-white flex text-2xl pl-48 pt-32 leading-[35px]">
      <div className="w-[40%]">
        <img
      ...
      <div className="w-[40%] pt-12 pl-10">
        <div className="h-4 w-[34%] mt-28 bg-[#f9e3b1] absolute z-10"></div>
        <p className="z-20 w-[36%] absolute">
