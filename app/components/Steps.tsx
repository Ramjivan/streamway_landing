...
const Steps = () => {
  return (
    <div className=" mt-44 bg-[#dff1ee]  ">
      <div className=" container  mx-auto ">
        <div className="title pt-28 leading-[50px] md:leading-[120px] text-center">
          <p className="text-slate-500 text-2xl tracking-wider ">GET STARTED IN MINUTES</p>
          <span className="text-5xl font-medium md:stpt relative z-0">
        ...
        <div className=" md:flex md:space-x-32 pt-20 w-full md:justify-center">
          ...
          <div className="img3 text-center md:w-1/5 space-y-5">
            <img
              className="mx-auto"
              src="https://html.creativegigstf.com/deski/deski/images/assets/ils_17.svg"
              alt=""
            />
            <p className="text-slate-500 text-xl  pt-6">Start selling ticket</p>
            <p className="text-xl ">
              Get payments, detailed data on tickets sales & message guests
              lorem
            </p>
          </div>
        </div>
