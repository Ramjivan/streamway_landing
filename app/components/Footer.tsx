...
const Footer = () => {
  return (
    <div className="bg-[#fbf3ec] ">
      ...
      <div className="  h-[400px] md:flex md:space-x-32 place-content-center">
        <div>
          <div className="text-black ml-20 md:ml-36 md:mt-20 space-y-2">
            ...
            <div>
              <Link
                className="ml-3  hover:underline hover:text-[#655c97]"
                href={"#"}
              >
                streamway@gmail.com
              </Link>
        ...
        <div className="ml-20 space-y-6 md:space-y-0 mt-10 md:mt-20 md:flex md:space-x-36 justify-center font-medium">
          <div className="space-y-2">
            ...
            <div>
              <Link className="mt-16 hover:underline" href={"#"}>
                Home
              </Link>
            </div>
            <div>
      ...
      <p className="text-center md:mt-0 mt-[500px] ml-3 text-xs  text-gray-500">
        Copyright @2022 streamway inc
      </p>
      </div>
    </div>
  );
