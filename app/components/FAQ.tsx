...
const FAQ = () => {
    ...
    const FAQs = [
      ...
      Answer: "mea case duis tollit et. Etiam nusquam set minium eu sea ei tale paulo elab mnesarch Et is veroincorrupte eos deserunt quaeren.",
      state:false,
      },
      {
        Question:"How does the free trial work?",
  ...
  return (
    <div className="  bg-[#dff1ee] justify-center relative mx-auto min-h-[1000px] md:h-auto w-screen">
      ...
      <div className="container w-[300px] md:w-[1170px] mx-auto">
        ...
        {FAQs.map((item)=>{
          const {Question , Answer , state} = item;
          return(
        
        <div className=" mx-auto  relative">
          <div className="lg:mx-56  h-[796px] opacity-[1]">
            <div className=" mx-auto absolute h-[796px] ">
              <div className="bg-white mb-3  flex flex-col h-[186] w-80 md:w-[700px] md:mx-auto">
                <div>
                  <h1 className="mb-0 text-left ">
                    <button className="w-full  md:md:text-xl text-left px-5 py-5 flex justify-between" >
                    <span>{Question}</span>
