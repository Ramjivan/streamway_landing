...
<div id="controls-carousel" className="relative" data-carousel="static">
    ...
    <div className="relative h-56  rounded-lg md:h-96">
        ...
        <div className="hidden duration-700 ease-in-out" data-carousel-item>
            <img src="https://html.creativegigstf.com/deski/deski/images/media/img_57.png"  className="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="..." />
        </div>
