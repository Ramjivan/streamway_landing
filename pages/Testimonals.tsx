            ...
            <div className='container mx-auto  mt-[130px] relative before:content-[url(../pages/images/fullopdot.svg)] before:animate-animation-bouncii before:absolute before:right-[10%] before:bottom-[0%] before:z-[]'>
                <div className='flex flex-col lg:flex-row justify-evenly relative before:content-[url(../pages/images/fullopdot.svg)] before:opacity-30 before:animate-animation-bouncii-rev before:absolute before:left-[8%] before:bottom-0 before:z-[]'>
                    ...
                    <div className='mx-auto lg:m-0 px-5 relative before:content-[url(../pages/images/lowopecitysq.svg)] before:animate-animation-bouncii before:absolute before:left-[-15%] before:top-[45%] before:z-[]'>
                        ...
                        <h1 className=' text-[30px] lg:text-[42px] max-w-[570px] roboto leading-[40px] lg:leading-[56px] pt-[22px] pb-[30px] relative before:content-[url(../pages/images/fullopdot.svg)] before:animate-animation-bouncii-rev before:absolute before:right-[-4%] before:top-[-5%] before:z-[65666]'>Deski combines excellent live chat, ticketing and automation that allow us to provide quality.</h1>
