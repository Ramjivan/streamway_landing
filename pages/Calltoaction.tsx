...
export const Calltoaction = () => {
    ...
    return (
        <div className='container mx-auto py-20'>
            <div className='max-w-[1170px] mx-auto bg-Call-to-action bg-no-repeat bg-center pt-[82px] px-[50px] pb-[89px] rounded-[40px]'>
                <div className=' flex justify-between lg:gap-0 md:gap-3 flex-col md:flex-row'>
                    <div>
                        ...
                        <h2 className='max-w-[520px] text-[30px] leading-[35px] lg:text-[48px] text-[#101621] font-extrabold lg:leading-[55px] text-left'>New here? Start your free trial now.</h2>
                    </div>
                    <div>
