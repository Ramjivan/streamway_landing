...
import { faWhatsapp, faFacebookF, faSquareFacebook, faInstagram, faTwitter, faYoutube } from '@fortawesome/free-brands-svg-icons'
  ...
  return (
    <>
      ...
      <div>
              ...
              <div className='flex justify-evenly my-[90px]  max-w-[1080px] mx-auto flex-wrap relative z-10 lg:before:content-[url(../pages/images/Groupiconn.png)] before:animate-animation-rotatee md:before:absolute md:before:bottom-[4%] md:before:right-[-1%] md:before:h-[57px] md:before:z-[-1]'>
                ...
                <Link href={'mailto:Contact@streamway.in'} target='_blank'>
                  <div className='max-w-[300px] h-[286px] shadow-lg shadow-black-500/50  pt-[20px] pb-[15px] md:mx-5 px-5 md:px-[41.5px] rounded-lg bg-white flex flex-col items-center cursor-pointer mb-5 md:mb-0 mr-4 mt-4'>
                    ...
                    <p className=' w-[265px] font-medium text-xl  text-center relative bottom-2'>Contact@streamway.in <br /> <Link href={'tel:+918386853447'}>+91-8386853447</Link> <br /><Link href={'tel:+7229997799'}>+91-7229997799</Link></p>
                  </div>
                </Link>
                <div className='max-w-[300px] h-[286px] shadow-lg shadow-black-500/50  pt-[20px] pb-[45px] mt-5 md:mx-5 px-[41.5px] rounded-lg bg-white flex flex-col place-items-center'>
                  ...
                  <Link href={'https://chat.whatsapp.com/DaQX7Hf5S13E7ACAfDNsvX'} target={"_blank"}> <button className="w-[220px] text-xl font-semibold bg-[#00c33d] rounded-xl py-3 text-white hover:text-[#00c33d] hover:bg-white duration-700">For help<FontAwesomeIcon className='text-[25px] relative left-[10px] top-[2px]  duration-200 ' icon={faWhatsapp} /></button></Link>
                </div>
              </div>
            </div>
          </div>
        ...
        {/*-------- Join Community -------- */}
        <div className="md:container mx-auto p-9 md:p-4 my-24 ">
          <div>
            <h3 className="text-xl sm:text-4xl md:text-5xl font-bold text-center tracking-normal">Join The StreamWay Community </h3>
            <p className="text-center text-xl md:text-3xl py-4 tracking-wide font-medium">Want to connect with other live streamer! Join than on Social </p>
          </div>
          <div className="">
            <ul className="flex justify-between mx-auto py-16 max-w-[700px] flex-wrap">
              <Link href={'https://chat.whatsapp.com/DaQX7Hf5S13E7ACAfDNsvX'} target={"_blank"} >
              ...
              <Link href={'https://www.facebook.com/groups/5982593718453831/'} target={"_blank"} >
                <li className="flex flex-col items-center cursor-pointer mb-5 md:mb-0 mr-4 mt-4">
                  <FontAwesomeIcon icon={faSquareFacebook} className='text-4xl text-blue-600 block' />
                  <b className="tracking-wider mt-4 text-base">Facebook Group</b>
                </li>
              </Link>
              <Link href={'https://www.instagram.com/streamway.in/'} target={"_blank"}>
                <li className="flex flex-col items-center cursor-pointer mb-5 md:mb-0 mr-4 mt-4">
                  <span>
              ...
              <Link href={'https://twitter.com/streamwayin'} target={"_blank"}>
                <li className="flex flex-col items-center cursor-pointer mb-5 md:mb-0 mr-4 mt-4">
                  <FontAwesomeIcon icon={faTwitter} className='text-4xl text-[#1da1f2] block' />
                  <b className="tracking-wider mt-4 text-base">Twitter</b>
                </li>
              </Link>
              <Link href={'https://www.youtube.com/@streamwayin'} target={"_blank"}>
                <li className="flex flex-col items-center cursor-pointer mb-5 md:mb-0 mr-4 mt-4">
                  <FontAwesomeIcon icon={faYoutube} className='text-4xl text-red-600 block' />
        ...
        <div className="py-9 bg-[#ecf6ff]">
          <p className=" text-center">Have a great idea for a new feature?
            <Link href={'https://forms.gle/Fqrw3ucvZucsgPRr8'} target={"_blank"} className="underline font-extrabold tracking-wide"> Tell us about it</Link>
          </p>
        </div>
        {/*-------- MAP --------- */}
        <div className="container mx-auto relative bg-black ">
          ...
          <div className="hidden md:block absolute rounded top-[14%] left-[20%] shadow-lg shadow-black-500/50  bg-white max-w-[440px] pr-[30px] py-[35px] pl-[50px]">
            ...
            <p className="text-lg roboto text-[#2A2A2A] pt-[5px] pb-[25px]">We&#39;re based in Pink City <Link href={"https://en.wikipedia.org/wiki/Jodhpur"} target={"_blank"} className='font-semibold '> Jodhpur </Link> @ Heart  of the land of the Kings Rajasthan</p>
            <Link href={'https://maps.app.goo.gl/XX5aG4NLcdp3y6Ag7'} target='_blank'> <span className=" text-lg  roboto text-[#000000A1] bg-[#ffb840] cursor-pointer py-4 px-7 rounded-2xl hover:bg-yellow-900 duration-700 hover:text-white">WE ARE HERE</span> </Link>
          </div>
        </div>
