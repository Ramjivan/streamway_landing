    ...
    return (
        <div>
            ...
            <div className='container mx-auto p-10'>
                <h1 className='text-left text-[44px] md:text-[55px] text-gray-800  roboto font-bold'>Terms of Service</h1>
                <div className='mt-11'>
                ...
                {/* Communications */}
                <h3 className='text-3xl mt-14 mb-6 roboto text-gray-700  font-semibold'>Communications</h3>
                <p className='text-justify text-xl'>By creating an Account on our service, you agree to subscribe to newsletters, marketing or promotional materials and other information we may send. However, you may opt out of receiving any, or all, of these communications from us by following the unsubscribe link or instructions provided in any email we send.</p>

                {/* Subscriptions */}
                <h3 className='text-3xl mt-14 mb-6  roboto text-gray-700  font-semibold'>Subscriptions</h3>
                ...
                {/* Free Trial  */}
                <h3 className='text-3xl mt-14 mb-6  roboto text-gray-700  font-semibold'>Free Trial</h3>
                ...
                {/* Fee Changes */}
                <h3 className='t    ext-3xl mt-14 mb-6  roboto text-gray-700  font-semibold'>Fee Changes</h3>
                ...
                {/* Refunds */}
                <h3 className='text-3xl mt-14 mb-6  roboto text-gray-700  font-semibold'>Refunds</h3>
                ...
                {/* Content */}
                <h3 className='text-3xl mt-14 mb-6  roboto text-gray-700  font-semibold'>Content</h3>
                ...
                {/* Accounts */}
                <h3 className='text-3xl mt-14 mb-6  roboto text-gray-700  font-semibold'>Accounts</h3>
                ...
                {/* Copyright Policy */}
                <h3 className='text-3xl mt-14 mb-6  roboto text-gray-700  font-semibold'>Copyright Policy</h3>
                ...
                <h3 className='text-3xl mt-14 mb-6  roboto text-gray-700  font-semibold'>DMCA Notice and Procedure for Copyright Infringement Claims</h3>
                ...
                <h3 className='text-3xl mt-14 mb-6  roboto text-gray-700  font-semibold'>Intellectual Property</h3>
                ...
                <h3 className='text-3xl mt-14 mb-6  roboto text-gray-700  font-semibold'>Links To Other Web Sites</h3>
                ...
                <h3 className='text-3xl mt-14 mb-6  roboto text-gray-700  font-semibold'>Third Party Services</h3>
                ...
                {/* Termination */}
                <h3 className='text-3xl mt-14 mb-6  roboto text-gray-700  font-semibold'>Termination</h3>
                ...
                {/* Indemnification  */}
                <h3 className='text-3xl mt-14 mb-6  roboto text-gray-700  font-semibold'>Indemnification</h3>
                ...
                <h3 className='text-3xl mt-14 mb-6  roboto text-gray-700  font-semibold'>Limitation Of Liability</h3>
                ...
                {/* Disclaimer */}
                <h3 className='text-3xl mt-14 mb-6  roboto text-gray-700  font-semibold'>Disclaimer</h3>
                ...
                {/* Exclusions */}
                <h3 className='text-3xl mt-14 mb-6  roboto text-gray-700  font-semibold'>Exclusions</h3>
                ...
                {/* Governing Law */}
                <h3 className='text-3xl mt-14 mb-6  roboto text-gray-700  font-semibold'>Governing Law</h3>
                ...
                {/* Changes */}
                <h3 className='text-3xl mt-14 mb-6  roboto text-gray-700  font-semibold'>Changes</h3>
