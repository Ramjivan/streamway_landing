    ...
    return (
        <div>
            ...
            <div className='container mx-auto p-10'>
                <h4 className='text-left text-[44px] md:text-[50px] text-gray-800 roboto font-bold'>Return and Cancellation Policy</h4>
                <div className='mt-11'>
                    ...
                    <p className='text-justify text-xl mt-4'>Refunds are only issued in cases of service delivery failure from our side. If a refund is approved, it will be processed within 5 to 8 working days from the date of approval.</p>
                ...
                <ul className='list-disc ml-14'>
                    ...
                    <li>
                        <p className='text-justify text-xl mt-4'>Similarly, in the case of prepaid packages, no refund is provided.</p>
                    </li>
                </ul>

                {/* Contact Us */}
                <h5 className='text-3xl mt-14 mb-6 roboto text-gray-700 font-semibold'>Contact Us</h5>
                <p className='text-justify text-xl'>If you have any further questions or need clarification about the Refund and Cancellation Policy, please reach out to us.</p>
            </div>
